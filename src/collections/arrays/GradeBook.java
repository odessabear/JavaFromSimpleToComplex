...
public class GradeBook {
    ...
    private static void varArgs() {
        ...
        System.out.println("Average of two elements is " + calcAverage(a,b));
        System.out.println("Average of three elements is " + calcAverage(a,b,c));
        System.out.println("Average of four elements is " + calcAverage(a,b,c,d));
